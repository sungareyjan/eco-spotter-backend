...
_formatUser(user) {
    ...
    if (user.profile.homeRegion) profiles.home_region = user.profile.homeRegion;
    if (user.profile.profilePictureUrl) profiles.profile_picture_url = user.profile.profilePictureUrl;
    }
